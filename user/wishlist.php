...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card-title { font-weight: 600; color: var(--primary); margin-bottom: 0.5rem; font-size: 1.1rem; }
        .card-price { color: var(--accent); font-weight: 700; font-size: 1.2rem; margin-bottom: 1rem; }
        
        .card-actions { margin-top: auto; display: flex; gap: 0.5rem; }
        .btn {
            flex: 1; padding: 0.6rem; border-radius: var(--radius-md); border: none;
        ...
        .empty-text { color: var(--text-light); margin-bottom: 2rem; font-size: 1.1rem; }
                ...
                <?php foreach($wishlist_items as $item): ?>
                    ...
                    <div class="product-card">
                        <a href="product_detail.php?id=<?php echo $item['id']; ?>">
                            <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="<?php echo htmlspecialchars($item['product_name']); ?>" class="product-img">
                        </a>
                        <div class="card-info">
