    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .compare-table th, .compare-table td {
            padding: 1.5rem; text-align: left; border-bottom: 1px solid #f1f5f9;
            vertical-align: top;
        }
        .compare-table th {
            width: 200px; background: #f8fafc; color: var(--text-light);
            font-weight: 600; position: sticky; left: 0; z-index: 10;
        ...
        .product-img {
            width: 150px; height: 150px; object-fit: contain; margin-bottom: 1rem;
...
<body>
    ...
    <main class="container main-content">
        ...
        <?php if (empty($products)): ?>
            <div style="text-align: center; padding: 4rem; background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm);">
                ...
                <p style="color: var(--text-light); margin-bottom: 2rem;">Select products from the catalog to compare them here.</p>
                            ...
                            <td>
                                <div style="color: #fbbf24; font-size: 0.9rem;">
                                    <?php 
                                        ...
                                        for($i=0; $i<5; $i++) { echo $i < round($rating) ? '★' : '☆'; } 
                                    ?>
                                    <span style="color: var(--text-light); margin-left: 5px;">(<?php echo number_format($rating, 1); ?>)</span>
                                </div>
                            </td>
                        <?php endforeach; ?>
                    </tr>
                        ...
                        <?php foreach($products as $product): ?>
                            <td>
                                <?php if($product['stock'] > 0): ?>
                                    <span style="color: #166534; background: #dcfce7; padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">In Stock</span>
                                <?php else: ?>
                                    <span style="color: #991b1b; background: #fee2e2; padding: 0.2rem 0.6rem; border-radius: 20px; font-size: 0.85rem; font-weight: 600;">Out of Stock</span>
                                <?php endif; ?>
                            </td>
                        <?php endforeach; ?>
                    </tr>
