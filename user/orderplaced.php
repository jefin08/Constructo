...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Main Content */
        .main-content { 
            margin-top: 100px; padding-bottom: 4rem; flex: 1; 
            display: flex; align-items: center; justify-content: center;
        }

        .success-card {
            background: white; border-radius: var(--radius-lg); padding: 3rem;
            box-shadow: var(--shadow-md); text-align: center; max-width: 600px; width: 100%;
        ...
        .checkmark-circle {
            ...
            vertical-align: top; margin-bottom: 1.5rem;
        }
        ...
        .checkmark-circle .checkmark {
            border-radius: 5px; display: block; position: absolute; opacity: 0;
            width: 80px; height: 80px; stroke-width: 2; stroke: var(--success); stroke-miterlimit: 10;
            box-shadow: inset 0px 0px 0px var(--success); animation: fill .4s ease-in-out .4s forwards, scale .3s ease-in-out .9s both;
        }
        .checkmark-circle .checkmark__circle {
            stroke-dasharray: 166; stroke-dashoffset: 166; stroke-width: 2; stroke-miterlimit: 10; stroke: var(--success); fill: none;
        ...
        @keyframes fill { 100% { box-shadow: inset 0px 0px 0px 30px #dcfce7; } }
        @keyframes slideUp { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }

        .success-title { font-size: 2rem; font-weight: 700; color: var(--primary); margin-bottom: 0.5rem; }
        .success-message { color: var(--text-light); font-size: 1.1rem; margin-bottom: 2rem; }

        .order-summary {
            background: #f8fafc; border-radius: var(--radius-md); padding: 1.5rem;
            margin-bottom: 2rem; text-align: left;
        }
        .order-row { display: flex; justify-content: space-between; margin-bottom: 0.5rem; font-size: 0.95rem; }
        .order-row span:first-child { color: var(--text-light); }
        .order-row span:last-child { font-weight: 600; color: var(--primary); }

        .actions { display: flex; flex-direction: column; gap: 1rem; }
        .btn-primary {
            display: inline-block; width: 100%; padding: 1rem; background: var(--primary);
        ...
        .btn-secondary {
            display: inline-block; width: 100%; padding: 1rem; background: transparent;
            color: var(--text-main); border: 1px solid #cbd5e1; border-radius: var(--radius-md);
            font-weight: 600; cursor: pointer; text-decoration: none; transition: var(--transition);
        }
        .btn-secondary:hover { background: #f1f5f9; border-color: var(--text-main); }
        ...
        <div class="success-card">
            ...
            <?php if (!empty($orders)): ?>
                ...
                <div class="actions">
                    ...
                    <a href="index.php" class="btn-secondary" style="border: none; color: var(--accent);">Continue Shopping</a>
                </div>
            <?php else: ?>
