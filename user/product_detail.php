    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn {
            ...
            cursor: pointer; border: none; gap: 0.5rem; font-size: 1rem;
        }
        ...
        /* Main Content */
        .main-content { margin-top: 100px; padding-bottom: 4rem; }

        /* Breadcrumbs */
        .breadcrumbs { margin-bottom: 2rem; color: var(--text-light); font-size: 0.9rem; }
        .breadcrumbs a { color: var(--text-light); text-decoration: none; transition: var(--transition); }
        ...
        /* Info Section */
        .product-info h1 { font-size: 2.5rem; color: var(--primary); line-height: 1.2; margin-bottom: 0.5rem; }
        .product-meta { display: flex; align-items: center; gap: 1rem; margin-bottom: 1.5rem; color: var(--text-light); font-size: 0.9rem; }
        ...
        .actions { display: flex; gap: 1rem; margin-bottom: 2.5rem; }
        .actions .btn { flex: 1; }

        /* Tabs */
        .tabs { margin-bottom: 2rem; border-bottom: 1px solid #e2e8f0; }
        .tab-btn {
            background: none; border: none; padding: 1rem 1.5rem; font-size: 1rem;
        ...
        .spec-table th, .spec-table td { padding: 1rem; text-align: left; border-bottom: 1px solid #f1f5f9; }
        .spec-table th { width: 30%; color: var(--text-light); font-weight: 500; }
        .spec-table td { color: var(--primary); font-weight: 600; }

        /* Related Products */
        .related-section { margin-top: 4rem; }
        .section-title { font-size: 1.5rem; font-weight: 700; color: var(--primary); margin-bottom: 1.5rem; }
        .related-grid {
        ...
        .card-title { font-weight: 600; color: var(--primary); margin-bottom: 0.5rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
...
<body>
    ...
    <main class="container main-content">
        ...
        <div class="breadcrumbs">
            ...
            <a href="index.php?category=<?php echo $product['category_id']; ?>"><?php echo htmlspecialchars($product['category_name']); ?></a> <span>/</span> 
        ...
        <div class="product-detail-grid">
            ...
            <div class="product-gallery">
                ...
                ?>
                <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="<?php echo htmlspecialchars($product['product_name']); ?>">
            </div>
            ...
            <div class="product-info">
                ...
                <div class="actions">
                    <button class="btn btn-primary" onclick="addToCart(<?php echo $product_id; ?>)"><i class="fas fa-shopping-cart"></i> Add to Cart</button>
                ...
                <div id="desc" class="tab-content active">
                    <p style="color: var(--text-main); line-height: 1.8;"><?php echo nl2br(htmlspecialchars($product['description'])); ?></p>
                </div>
                ...
                <div id="specs" class="tab-content">
                    <table class="spec-table">
                        ...
                        <tr><th>Weight</th><td><?php echo htmlspecialchars($product['weight']); ?> kg</td></tr>
                        <tr><th>Packing Type</th><td><?php echo htmlspecialchars($product['type_of_packing']); ?></td></tr>
                        <tr><th>Quality</th><td><?php echo htmlspecialchars($product['quality']); ?></td></tr>
                    </table>
                </div>
            </div>
        </div>
                ...
                <?php foreach($related_products as $rel): ?>
                    <?php
                        ...
                        if (!filter_var($relImg, FILTER_VALIDATE_URL)) {
                            ...
                            $relImg = SUPABASE_STORAGE_URL . $relImg;
                        }
                    ?>
                    <div class="product-card">
                        <a href="product_detail.php?id=<?php echo $rel['id']; ?>" style="text-decoration: none; color: inherit;">
                            <img src="<?php echo htmlspecialchars($relImg); ?>" alt="<?php echo htmlspecialchars($rel['product_name']); ?>" class="product-img">
                            <div class="card-info">
