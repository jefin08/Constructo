...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-header p { font-size: 1.25rem; color: var(--text-light); max-width: 600px; margin: 0 auto; }
        ...
        .contact-card h2 { font-size: 1.75rem; color: var(--primary); margin-bottom: 1.5rem; }
        ...
        .info-icon {
            width: 48px; height: 48px; background: rgba(245, 158, 11, 0.1); color: var(--accent);
            border-radius: 12px; display: flex; align-items: center; justify-content: center;
            font-size: 1.25rem; flex-shrink: 0;
        }
        .info-content h3 { font-size: 1.1rem; color: var(--primary); margin-bottom: 0.25rem; }
        .info-content p { color: var(--text-light); }

        .alert {
            padding: 1rem; border-radius: var(--radius-md); margin-bottom: 2rem;
