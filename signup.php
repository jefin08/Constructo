...
// Initialize variables to empty strings to prevent undefined variable warnings
$first_name = "";
$last_name = "";
$email = "";
$message = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($first_name) || empty($last_name) || empty($email) || empty($password)) {
        ...
        try {
            ...
            $check_sql = "SELECT email FROM clients WHERE email = :email UNION SELECT email FROM admin WHERE email = :email2";
            $check_stmt = $conn->prepare($check_sql);
            $check_stmt->bindParam(':email', $email);
            $check_stmt->bindParam(':email2', $email);
            $check_stmt->execute();
            ...
            if ($check_stmt->rowCount() > 0) {
                ...
                // Insert new client
                $insert_sql = "INSERT INTO clients (first_name, last_name, email, password, status) VALUES (:first_name, :last_name, :email, :password, 'active')";
...
<head>
    ...
    <title>Sign Up - Constructo</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* Modern CSS Reset & Variables (Matching index.php & login.php) */
        :root {
            --primary: #0f172a;
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn {
            ...
            cursor: pointer; border: none; gap: 0.5rem; width: 100%;
        }
            ...
            <form action="" method="post">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="first_name" name="first_name" value="<?php echo htmlspecialchars($first_name); ?>" placeholder="John" required>
                    </div>
                    <div class="form-group">
                        <label for="last_name">Last Name</label>
                        <input type="text" id="last_name" name="last_name" value="<?php echo htmlspecialchars($last_name); ?>" placeholder="Doe" required>
                    </div>
                </div>
