...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Hero */
        .hero {
            padding: 8rem 0 5rem; min-height: 90vh; display: flex; align-items: center;
            background: linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%);
            position: relative; overflow: hidden;
        }
        .hero::before {
            content: ''; position: absolute; top: -10%; right: -5%; width: 50%; height: 80%;
        ...
        .hero-text h1 { font-size: 3.5rem; line-height: 1.1; margin-bottom: 1.5rem; color: var(--primary); }
        .hero-text p { font-size: 1.25rem; color: var(--text-light); margin-bottom: 2.5rem; max-width: 500px; }
        .hero-image img { width: 100%; height: auto; border-radius: var(--radius-lg); box-shadow: var(--shadow-lg); transform: perspective(1000px) rotateY(-5deg); transition: var(--transition); }
        ...
        .card {
            ...
            text-align: center; padding-bottom: 1rem; border: 1px solid rgba(0,0,0,0.05);
        }
        .card:hover { transform: translateY(-5px); box-shadow: var(--shadow-lg); }
        .card img { width: 100%; height: 160px; object-fit: cover; }
        .card-title { font-weight: 600; margin-top: 1rem; color: var(--primary); }
        ...
        .product-name { font-size: 1.25rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--primary); }
        .product-price { font-size: 1.5rem; color: var(--accent); font-weight: 700; margin-bottom: 1.5rem; }
        .product-info .btn { margin-top: auto; width: 100%; }
        ...
        .footer-col h3 { font-size: 1.5rem; margin-bottom: 1.5rem; color: var(--accent); }
        .footer-links a { display: block; color: #94a3b8; text-decoration: none; margin-bottom: 0.75rem; transition: var(--transition); }
        .footer-links a:hover { color: white; padding-left: 5px; }
        .copyright { text-align: center; padding-top: 2rem; border-top: 1px solid rgba(255,255,255,0.1); color: #64748b; }
        ...
        @media (max-width: 768px) {
            ...
            .nav-links { display: none; } /* Simplified for this task, ideally a hamburger menu */
...
<body>
    ...
    <nav>
        <div class="container nav-container">
            <div class="logo">
                <img src="<?php echo file_exists('images/logo.png') ? 'images/logo.png' : 'https://yyeploxrzxwhhsnffexp.supabase.co/storage/v1/object/public/Construct_image/logo.png'; ?>" alt="Constructo Logo">
                Constructo
            </div>
            <div class="nav-links">
                <a href="#">Home</a>
    ...
    <header class="hero">
        <div class="container hero-content">
            <div class="hero-text">
                ...
                <p>Your premium online platform for all construction materials. Quality, reliability, and efficiency delivered directly to your site.</p>
                <div class="hero-actions">
                    <a href="signup.php" class="btn btn-accent"><i class="fas fa-arrow-right"></i> Get Started</a>
                </div>
            </div>
            <div class="hero-image">
                <img src="<?php echo file_exists('images/hero_image.png') ? 'images/hero_image.png' : 'https://yyeploxrzxwhhsnffexp.supabase.co/storage/v1/object/public/Construct_image/index1.png'; ?>" alt="Construction Site">
            </div>
        </div>
    </header>
            ...
            <div class="container">
                ...
                <div class="about-grid">
                    <div class="about-text">
                        <p>At Constructo, we connect you with the best online resources for all your construction material needs. Whether you're a contractor, architect, or DIY enthusiast, our platform provides a comprehensive selection of materials at competitive prices.</p>
                        <p>Our user-friendly interface allows you to search for materials quickly, compare prices, and read customer reviews. With partnerships with leading suppliers, we ensure that you receive high-quality products delivered directly to your site.</p>
                        <a href="about_us.html" class="btn btn-primary">Learn More</a>
                    </div>
                    <div class="about-img">
                        <img src="<?php echo file_exists('images/about_us.png') ? 'images/about_us.png' : 'https://yyeploxrzxwhhsnffexp.supabase.co/storage/v1/object/public/Construct_image/index5.jpeg'; ?>" alt="Construction Materials">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="section" id="products">
            <div class="container">
                ...
                <div class="product-grid">
                    <?php
                        try {
                            $sql = "SELECT product_name, description, image_url, price FROM products LIMIT 6";
                            $stmt = $conn->query($sql);
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-col">
                    <h3>Constructo</h3>
                    <p style="color: #94a3b8;">Your one-stop platform for all construction materials. Quality and reliability you can trust.</p>
                </div>
                <div class="footer-col">
                    <h3>Quick Links</h3>
