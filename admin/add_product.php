    ...
    if ($check === false) {
        ...
        if (uploaded_images($_FILES["image"]["tmp_name"], $target_file)) {
            try {
                ...
                $sql = "INSERT INTO products (product_name, description, price, category_id, image_url, brand, rating, type_of_packing, weight, quality, stock) 
                        VALUES (:product_name, :description, :price, :category_id, :image_url, :brand, :rating, :type_of_packing, :weight, :quality, :stock)";
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" id="product_name" name="product_name" required placeholder="e.g. Premium Cement">
                        </div>

                        <div class="form-group full-width">
                            <label for="description">Description</label>
                            <textarea id="description" name="description" rows="4" required placeholder="Detailed product description..."></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="category" name="category" required placeholder="e.g. Building Materials">
                        </div>
