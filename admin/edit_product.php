...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        $target_file = $target_dir . time() . "_" . $file_name; // Add timestamp to avoid conflict
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Content Area */
        .content-area { padding: 2rem; max-width: 1000px; margin: 0 auto; width: 100%; }
        ...
        .form-header h2 { font-size: 1.25rem; color: var(--primary); }
        ...
        .file-upload-icon { font-size: 2rem; color: var(--text-light); margin-bottom: 0.5rem; }
        ...
        <div class="content-area">
            ...
            <div class="form-card">
                <div class="form-header">
                    ...
                    <a href="view_products.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to List</a>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="stock" name="stock" min="1" value="<?php echo htmlspecialchars($product['stock']); ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="category">Category</label>
                            <input type="text" id="category" name="category" value="<?php echo htmlspecialchars($product['category_name'] ?? ''); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="rating" name="rating" step="0.1" min="0" max="5" value="<?php echo htmlspecialchars($product['rating']); ?>">
                        </div>

                        <div class="form-group">
                            <label for="type_of_packing">Type of Packing</label>
                            <input type="text" id="type_of_packing" name="type_of_packing" value="<?php echo htmlspecialchars($product['type_of_packing']); ?>">
                        </div>

                        <div class="form-group">
                            <label for="weight">Weight</label>
                            <input type="text" id="weight" name="weight" value="<?php echo htmlspecialchars($product['weight']); ?>">
                        </div>

                        <div class="form-group">
                            <label for="quality">Quality Grade</label>
                            <input type="text" id="quality" name="quality" value="<?php echo htmlspecialchars($product['quality']); ?>">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <?php 
                                ...
                                if (!filter_var($imgUrl, FILTER_VALIDATE_URL)) {
                                    ...
                                    $imgUrl = "https://yyeploxrzxwhhsnffexp.supabase.co/storage/v1/object/public/Construct_image/" . $filename;
                                }
                            ?>
                            <div style="display: flex; gap: 1rem; align-items: flex-start;">
                                <div>
                                    <div style="font-size: 0.85rem; color: var(--text-light); margin-bottom: 0.5rem;">Current Image:</div>
                                    <img src="<?php echo htmlspecialchars($imgUrl); ?>" alt="Current Product Image" class="current-image" onerror="this.src='data:image/svg+xml;base64,'">
                                </div>
                                <div style="flex: 1;">
                                    <div class="file-upload" onclick="document.getElementById('image').click()">
                                        ...
                                        <div style="font-size: 0.8rem; color: #94a3b8; margin-top: 0.5rem;">Max size: 5MB (JPG, PNG)</div>
                                        <input type="file" id="image" name="image" accept="image/*" onchange="updateFileName(this)">
                                    </div>
                                    <div id="file-name" style="margin-top: 0.5rem; font-size: 0.9rem; color: var(--primary);"></div>
                                </div>
                            </div>
                        </div>
                    </div>
