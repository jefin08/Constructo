            ...
            <div class="page-grid">
                ...
                <div class="form-card">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input type="text" id="vendor_name" name="vendor_name" required placeholder="e.g. ABC Suppliers">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="file-upload" onclick="document.getElementById('vendor_image').click()">
                                ...
                                <input type="file" id="vendor_image" name="vendor_image" accept="image/*" required onchange="updateFileName(this)">
                            </div>
                ...
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <span style="color: var(--text-light); font-size: 0.9rem;">Total: <?php echo count($vendors); ?></span>
                    </div>
                    <table>
                        <thead>
                            <tr>
                                        ...
                                        <td>
                                            <?php 
                                                ...
                                                if (!filter_var($imageUrl, FILTER_VALIDATE_URL)) {
                                                    ...
                                                    // Assuming SUPABASE_STORAGE_URL is defined in db_connect.php or elsewhere
                                                    // For local testing, you might want to adjust this to point to your local uploaded_images folder
                                                    $imageUrl = (defined('SUPABASE_STORAGE_URL') ? SUPABASE_STORAGE_URL : '') . $filename;
                                                }
                                            ...
                                            ?>
                                            <img src="<?php echo htmlspecialchars($imageUrl); ?>" class="vendor-img" alt="<?php echo htmlspecialchars($row['vendor_name']); ?>" onerror="this.src='<?php echo $placeholder; ?>'">
                                        </td>
                                        <td style="font-weight: 500;"><?php echo htmlspecialchars($row['vendor_name']); ?></td>
                                        <td>
                                            <a href="add_vendors.php?delete_id=<?php echo $row['id']; ?>" class="btn-delete" onclick="return confirm('Are you sure you want to delete this vendor?');">
