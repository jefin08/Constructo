...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-activate { color: #059669; background: #ecfdf5; border-color: #a7f3d0; padding: 0.4rem 0.8rem; font-size: 0.85rem; font-weight: 500; }
        .btn-activate:hover { background: #d1fae5; }
        .btn-deactivate { color: #d97706; background: #fffbeb; border-color: #fde68a; padding: 0.4rem 0.8rem; font-size: 0.85rem; font-weight: 500; }
        .btn-deactivate:hover { background: #fef3c7; }
        .btn-delete { color: #dc2626; background: #fef2f2; border-color: #fecaca; padding: 0.4rem 0.8rem; font-size: 0.85rem; font-weight: 500; margin-left: 0.5rem; }
        ...
        <div class="content-area">
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <span style="color: var(--text-light); font-size: 0.9rem;">Total: <?php echo count($users); ?></span>
                </div>
                <table id="usersTable">
                    <thead>
                        <tr>
                        ...
                        <?php if (count($users) > 0): ?>
                            <?php foreach($users as $row): ?>
                                <tr>
                                    ...
                                    <td style="color: var(--text-light);"><?php echo date('M d, Y', strtotime($row["created_at"])); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <button type="submit" class="action-btn btn-delete" onclick="return confirm('Are you sure you want to delete this user? This action cannot be undone.');" title="Delete User">
