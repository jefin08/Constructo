...
try {
    ...
    $sql = "SELECT id, name, email, message, created_at FROM contact_messages ORDER BY id DESC";
    $stmt = $conn->query($sql);
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-reply { color: #0ea5e9; background: #e0f2fe; border-color: #bae6fd; padding: 0.4rem 0.8rem; }
        .btn-reply:hover { background: #bae6fd; }
        
        .btn-delete { color: #dc2626; background: #fef2f2; border-color: #fecaca; padding: 0.4rem 0.8rem; margin-left: 0.5rem; }
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="search-container">
                <input type="text" id="searchInput" onkeyup="filterTable()" placeholder="Search by name or email..." class="search-input">
            </div>

            <div class="table-card">
                <div class="table-header">
                    <h3>Inbox</h3>
                    <span style="color: var(--text-light); font-size: 0.9rem;">Total: <?php echo count($messages); ?></span>
                </div>
                        ...
                        <?php if (count($messages) > 0): ?>
                            <?php foreach($messages as $row): ?>
                                <tr>
                                    ...
                                    <td style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" title="<?php echo htmlspecialchars($row["message"]); ?>">
                                    ...
                                    <td>
                                        <a href="mailto:<?php echo htmlspecialchars($row["email"]); ?>" class="action-btn btn-reply" title="Reply via Email">
                                        ...
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <button type="submit" class="action-btn btn-delete" onclick="return confirm('Are you sure you want to delete this message?');" title="Delete Message">
