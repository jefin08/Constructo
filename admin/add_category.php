...
// Define STORAGE_URL if not already defined (assuming it's in db_connect.php or a config file)
// For demonstration, let's define a placeholder if it's not provided by the user's context.
// STORAGE_URL is defined in db_connect.php
                ...
                <div class="table-card">
                    <div class="table-header">
                        ...
                        <span style="color: var(--text-light); font-size: 0.9rem;">Total:
                            <?php echo count($categories); ?></span>
                    </div>
                    <table>
                        <thead>
                            <tr>
                                ...
                                <?php foreach ($categories as $row): ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <img src="<?php echo htmlspecialchars($imageUrl); ?>" class="category-img"
                                                alt="<?php echo htmlspecialchars($row['category_name']); ?>"
                                                onerror="this.src='<?php echo $placeholder; ?>'">
                                        </td>
                                        <td style="font-weight: 500;"><?php echo htmlspecialchars($row['category_name']); ?>
                                        </td>
                                        <td>
                                            ...
                                            <a href="add_category.php?delete_id=<?php echo $row['id']; ?>" class="btn-delete"
